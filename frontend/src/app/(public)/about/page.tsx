        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="mb-12">
              ...
              <p className="mb-4 text-(--earist-body-text)">
              ...
              <p className="text-(--earist-body-text)">
                ...
                TypeScript, and Tailwind CSS, the GS-IS provides a responsive
                and accessible interface for all user roles: Administrators,
                Students, Panelists, Applicants, and Custom roles.
              </p>
            </div>

            {/* Mission & Vision */}
            <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="rounded-lg border border-(--earist-border-gray) p-6">
                <div className="mb-4 flex items-center gap-2">
                  <Target className="h-6 w-6 text-(--earist-accent)" />
              ...
              <div className="rounded-lg border border-(--earist-border-gray) p-6">
                <div className="mb-4 flex items-center gap-2">
                  <Eye className="h-6 w-6 text-(--earist-accent)" />
                  <h3 className="text-lg font-bold text-(--earist-primary)">
                    Vision
                  </h3>
                </div>
            ...
            <div className="mb-12 grid grid-cols-2 gap-6 md:grid-cols-4">
              {stats.map((stat) => (
                <div
                  key={stat.label}
                  className="flex flex-col items-center rounded-lg bg-(--earist-surface-light-red) p-6 text-center"
                >
                  <stat.icon className="mb-3 h-8 w-8 text-(--earist-accent)" />
            ...
            {/* Key Features */}
            <div>
              <h2 className="mb-6 text-2xl font-bold text-(--earist-primary)">
                Key Features
              </h2>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {[
                  ...
                  <div
                    key={feature}
                    className="flex items-start gap-2 rounded-lg border border-(--earist-border-gray) p-3"
                  >
                    <div className="mt-0.5 h-2 w-2 shrink-0 rounded-full bg-(--earist-accent)" />
                    <span className="text-sm text-(--earist-body-text)">
                      {feature}
                    </span>
                  </div>
