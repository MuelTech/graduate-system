  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <Card>
          <CardContent className="p-3">
            <p className="text-xs text-[var(--earist-body-text)]">Internal</p>
            <p className="text-lg font-bold text-[var(--earist-primary)]">
              {internalCount}
            </p>
          </CardContent>
        ...
        <Card>
          <CardContent className="p-3">
            <p className="text-xs text-[var(--earist-body-text)]">External</p>
            <p className="text-lg font-bold text-[var(--earist-primary)]">
              {externalCount}
            </p>
          </CardContent>
      ...
      <Card>
        <CardContent className="p-0">
              ...
              <tbody>
                {filteredPanelists.map((panelist) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      <span className="text-sm font-medium text-[var(--earist-primary)]">
          ...
          <div className="flex items-center justify-between border-t border-[var(--earist-border-gray)] px-4 py-3">
            <p className="text-xs text-[var(--earist-body-text)]">
              Showing {filteredPanelists.length} of {panelists.length}{" "}
              panelists
            </p>
