  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-[var(--earist-body-text)]">
          ...
          <a
            ...
            className="font-semibold text-[var(--earist-secondary)] hover:underline"
          >
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[var(--earist-primary)] text-[10px] font-bold text-white">
                1
              </div>
              <p className="text-sm text-[var(--earist-body-text)]">
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="text-sm text-[var(--earist-body-text)]">
                ...
                <span className="font-semibold">STRIKE API</span> for
                automatic plagiarism analysis.
              </p>
            </div>
            <div className="flex items-start gap-2">
              <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[var(--earist-primary)] text-[10px] font-bold text-white">
          ...
          <CardContent>
            {!file ? (
              <div
                ...
                className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-[var(--earist-border-gray)] p-8 transition-colors hover:border-[var(--earist-primary)] hover:bg-[var(--earist-surface-gray)]"
              >
        ...
        <Card>
          <CardContent className="py-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs text-[var(--earist-body-text)]">
                Your manuscript is being analyzed by StrikePlagiarism.com.
                This may take a few minutes.
              </p>
              <div className="mt-4 h-2 w-48 overflow-hidden rounded-full bg-[var(--earist-border-gray)]">
                <div className="h-full w-2/3 animate-pulse rounded-full bg-[var(--earist-primary)]" />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent>
          {history.length === 0 ? (
            <p className="text-sm text-[var(--earist-body-text)] text-center py-4">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--earist-border-gray)] bg-[var(--earist-surface-gray)]">
                    <th className="px-4 py-2 text-left font-semibold text-[var(--earist-secondary)]">
                      Date
                    </th>
                    <th className="px-4 py-2 text-center font-semibold text-[var(--earist-secondary)]">
                      Similarity
                    </th>
                    <th className="px-4 py-2 text-center font-semibold text-[var(--earist-secondary)]">
                      Status
                    </th>
                    <th className="px-4 py-2 text-right font-semibold text-[var(--earist-secondary)]">
                      Report
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {history.map((entry, i) => (
                    ...
                    >
                      <td className="px-4 py-2 text-[var(--earist-body-text)]">
                        {entry.date}
                      </td>
                      <td className="px-4 py-2 text-center font-medium text-[var(--earist-primary)]">
                        {entry.similarity}%
                      </td>
                      ...
                      <td className="px-4 py-2 text-right">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1 text-xs font-semibold text-[var(--earist-secondary)] hover:text-[var(--earist-primary)]"
                        >
