...
export default function StudentRepositoryPage() {
  ...
  const researchEntries = [
    {
      ...
      program: "MSCS",
      year: 2026,
      abstract: "This study explores the application of machine learning algorithms for early detection of students at academic risk. Using historical academic data from EARIST, the researchers developed a predictive model that identifies at-risk students with 87% accuracy. The system analyzes factors including attendance patterns, quiz scores, and assignment submission timeliness to generate early warnings for academic advisors. Results show that early intervention based on the model's predictions improved student retention by 15%.",
      keywords: ["machine learning", "academic risk", "prediction", "student performance", "early detection"],
      datePublished: "May 28, 2026",
      downloadAllowed: true,
      citation: "Santos, M. (2026). Machine Learning Approaches for Early Detection of Student Academic Risk. EARIST Graduate School Repository.",
    },
    {
      id: 2,
      ...
      downloadAllowed: true,
      citation: "Torres, E. (2026). Effectiveness of Blended Learning in Graduate Education. EARIST Graduate School Repository.",
    },
    {
      id: 3,
      ...
      downloadAllowed: true,
      citation: "Luna, C. (2026). Blockchain for Academic Credential Verification. EARIST Graduate School Repository.",
    },
    {
      id: 4,
      ...
      keywords: ["student engagement", "online advising", "thesis", "graduate students"],
      datePublished: "June 3, 2026",
      downloadAllowed: false,
      citation: "Garcia, A. (2026). Student Engagement Strategies in Online Thesis Advising. EARIST Graduate School Repository.",
    },
    {
      id: 5,
      ...
      downloadAllowed: true,
      citation: "Reyes, P. (2025). Curriculum Mapping for Industry-Aligned Graduate Programs. EARIST Graduate School Repository.",
    },
  ];
  ...
  const years = [...new Set(researchEntries.map((e) => e.year))].sort((a, b) => b - a);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        <Badge className="bg-[var(--earist-surface-gray)] text-[var(--earist-body-text)]">
        ...
        <CardContent className="py-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <select value={yearFilter} onChange={(e) => setYearFilter(e.target.value)} className="rounded-lg border border-[var(--earist-border-gray)] px-3 py-2 text-sm text-[var(--earist-body-text)] focus:border-[var(--earist-primary)] focus:outline-none">
              ...
              <Card key={entry.id}>
                <CardContent className="p-0">
                  <button
                    ...
                    className="flex w-full items-start gap-4 p-4 text-left transition-colors hover:bg-[var(--earist-surface-gray)]"
                  >
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[var(--earist-surface-light-red)]">
                    ...
                    <div className="shrink-0">
                      {isExpanded ? (
                        <ChevronUp className="h-5 w-5 text-[var(--earist-body-text)]" />
                      ) : (
                        <ChevronDown className="h-5 w-5 text-[var(--earist-body-text)]" />
                      )}
                    </div>
                  </button>
                  ...
                  {/* Expanded Content */}
                  {isExpanded && (
                    <div className="border-t border-[var(--earist-border-gray)] px-4 py-4">
                      <div className="space-y-4">
                        {/* Abstract */}
                        <div>
                        ...
                        <div>
                          ...
                          <p className="rounded-lg bg-[var(--earist-surface-gray)] p-3 text-xs text-[var(--earist-body-text)] italic">
                            {entry.citation}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between rounded-lg bg-[var(--earist-surface-gray)] p-3">
                          <div className="flex items-center gap-2">
                            <Download className="h-4 w-4 text-[var(--earist-body-text)]" />
                          ...
                          {entry.downloadAllowed ? (
                            <Button size="sm" className="bg-[var(--earist-primary)] text-white hover:bg-[var(--earist-primary)]/90">
