      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {programs.map((program) => (
            <div
              key={program.name}
              className="group overflow-hidden rounded-lg border border-[var(--earist-border-gray)] bg-white shadow-sm transition-all hover:shadow-lg"
            >
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-[var(--earist-muted-foreground)]">
        ...
        <div className="mt-10 text-center">
          <Link
            href="/programs"
            className="inline-flex items-center gap-2 text-sm font-semibold text-[var(--earist-secondary)] transition-colors hover:text-[var(--earist-primary)]"
          >
            View All Programs
